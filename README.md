...
To start the graphical user interface for this project, use the following command (assuming you are using the local virtual environment):

```bash
.venv/bin/streamlit run src/qubo_project/gui.py
```
